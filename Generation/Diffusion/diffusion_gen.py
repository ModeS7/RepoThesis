...
modelname = r"C:\NTNU\RepoThesis\trained_model\default_2_seg\syn_seg_16_Epoch199_of_200"
...
modelname_mr = r"C:\NTNU\RepoThesis\trained_model\default_2\conditional_syn_bravo_from_seg_16_Epoch199_of_200"
...
def sample_img(mask_image, counter):
    ...
    if num_pixels == num_pixels_correct:
        ...
        nib.save(nifti_image, fr"C:\NTNU\MedicalDataSets\synthetic_dataset_default\{counter}.nii.gz")
...
#############Saving images########################
bolk = 70 #lagrer bildene bolkvis --> fortere
k = 0
#########################################
